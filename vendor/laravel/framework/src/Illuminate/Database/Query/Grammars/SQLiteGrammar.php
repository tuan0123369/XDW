...
class SQLiteGrammar extends Grammar
{
    ...
    /**
     * Compile a "source/jsON length" statement into SQL.
     *
     * @param  string  $column
    ...
    /**
     * Compile a "source/jsON" patch statement into SQL.
     *
     * @param  string  $column
     * @param  mixed  $value
     * @return string
    ...
    {
        return "source/json_patch(ifnull({$this->wrap($column)}, json('{}')), json({$this->parameter($value)}))";
    }
