...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        $cssFile      = $this->getResource("source/css/whoops.base.css");
        $zeptoFile    = $this->getResource("source/js/zepto.min.js");
        $prismJs = $this->getResource("source/js/prism.js");
        $prismCss = $this->getResource("source/css/prism.css");
        $clipboard    = $this->getResource("source/js/clipboard.min.js");
        $jsFile       = $this->getResource("source/js/whoops.base.js");
