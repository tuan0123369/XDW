                ...
                <div class="single-post row">
                    <div class="col-lg-12">
                        <div class="feature-img">
                            <img class="User/img-fluid" src="User/img/blog/feature-img1.jpg" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9 col-md-9 blog_details">
                        <h2>{{$ctbaiviet->name_blog}}</h2>
                        <p class="excert">
                           {{$ctbaiviet->description}}
                        </p>
                        <p>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <img class="User/img-fluid" src="User/img/blog/post-img1.jpg" alt="">
                            </div>
                            <div class="col-6">
                                <img class="User/img-fluid" src="User/img/blog/post-img2.jpg" alt="">
                            </div>
                ...
                <div class="navigation-area">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                            <div class="thumb">
                                <a href="#"><img class="User/img-fluid" src="User/img/blog/prev.jpg" alt=""></a>
                            </div>
                            <div class="arrow">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                            ...
                            <div class="thumb">
                                <a href="#"><img class="User/img-fluid" src="User/img/blog/next.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="comments-area">
                    ...
                    <div class="comment-list left-padding">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="User/img/blog/c3.jpg" alt="">
                                </div>
                                <div class="desc">
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="User/img/blog/c4.jpg" alt="">
                                </div>
                                <div class="desc">
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="User/img/blog/c5.jpg" alt="">
                                </div>
                                <div class="desc">
            ...
            <div class="col-lg-4">
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget ads_widget">
                        <a href="#"><img class="User/img-fluid" src="User/img/blog/add.jpg" alt=""></a>
                        <div class="br"></div>
                    </aside>
